...
api_id=12332821,
api_hash='c27120146b483d7ba0b271c9282078df',
session_name=bot_id,
token=Token
}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " الجبوري "
SudosS = {874820580}
...
type = 'inline',
data = {
{{text = ' 🇮🇶 ┇ 𝖲𝗈𝗎𝗋𝖼𝖾 𝐋𝐀𝐂𝐎𝐒𝐓𝐄',url="t.me/LACOSTE2024"}},
}
}
...
{{text = ' 🇮🇶 ┇ تغيير اسم البوت',data="namebot"},{text =(redis:get(bot_id..":namebot") or "الجبوري "),data="delnamebot"}},
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/LACOSTE2024&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "الساعة" then
bot.sendText(msg.chat_id,msg.id,"*  🇮🇶 ┇الساعة الان : ( "..os.date("%I:%M%p").." )*","md",true)  
end
if text == "شسمك" or text == "سنو اسمك" then
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "الجبوري "),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "الجبوري "),"اني لقميل "..(redis:get(bot_id..":namebot") or "الجبوري "),(redis:get(bot_id..":namebot") or "الجبوري ").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "الجبوري ") then
...
local UserId_Info = bot.searchPublicChat("𝐋𝐀𝐂𝐎𝐒𝐓𝐄_labban")
if UserId_Info.id then
...
local Text = "*ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ 𝐋𝐀𝐂𝐎𝐒𝐓𝐄\n\n*[ 🇮🇶 ┇  𝐋𝐀𝐂𝐎𝐒𝐓𝐄 ᴄʜᴀɴɴᴇʟ](http://t.me/LACOSTE2024)*\n\n*[ 🇮🇶 ┇  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/LACOSTE2024)*\n\n*[ 🇮🇶 ┇  𝐋𝐀𝐂𝐎𝐒𝐓𝐄 ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/𝐋𝐀𝐂𝐎𝐒𝐓𝐄_labban)*\n\n*[ 🇮🇶 ┇  ʙᴏᴛ 𝐋𝐀𝐂𝐎𝐒𝐓𝐄](http://t.me/LACOSTE2024)*\n*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝖲𝗈𝗎𝗋𝖼𝖾 𝐋𝐀𝐂𝐎𝐒𝐓𝐄 ',url="t.me/LACOSTE2024"}
